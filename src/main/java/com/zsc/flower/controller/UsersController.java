...
//        System.out.println(status);
    ...
    public ResponseData updatePassword(@RequestParam("oldPassword") String oldPassword, @RequestParam("newPassword") String newPassword, HttpServletRequest request) {
        try {
            String jwt = request.getHeader("token");
            Users users = usersService.findUserById(Long.parseLong(tokenService.reUserIdBytoken(jwt)));
    ...
    public ResponseData getUserMsg(HttpServletRequest request) {
        ...
        Users user;
        if (!jwt.equals("null")) {
            user = usersService.findUserById(Long.parseLong(tokenService.reUserIdBytoken(jwt)));
            responseData.setData(user);
        }else{
