...
//		//pageInfo不能为空
//		PageInfo pageInfo = (PageInfo) request.getAttribute(bean);
//		if (pageInfo == null)
//			return SKIP_BODY;
...
//				String preUrl = append(url, "page", pageInfo.getPages() - 1);
//			//	preUrl = append(preUrl, "rows", pageInfo.getSize());
...
//			int indexPage =1;
//			if(pageInfo.getPageNum() - 2 <=0){
//				indexPage=1;
//			}else if(pageCount-pageInfo.getPageNum() <=2){
//				indexPage=((int)pageCount-4>0)?((int)pageCount-4):1;
//			}else{
//				indexPage= pageInfo.getPageNum() - 2;
//			}
//			//System.out.println("初始页为:"+ indexPage);
//    for (int i= 1;i <= number && indexPage <= pageCount;indexPage++,i++){
//				if (indexPage == pageInfo.getPageNum()) {
//			writer.print("<li class=\"active\"><a href=\"#\">" + indexPage
//				+"<spanclass=\"sr-only\"></span></a></li>");
//					continue;
//				}
//				String pageUrl = append(url, "page", indexPage);
//				//pageUrl = append(pageUrl, "rows", pageInfo.getSize());
//writer.print("<li><a href=\"" + pageUrl + "\">" + indexPage + "</a></li>");
//			}
//			// 显示“下一页”按钮
//			if (pageInfo.getPageNum() < pageCount) {
//				String nextUrl = append(url, "page", pageInfo.getPageNum() + 1);
//				//nextUrl = append(nextUrl, "rows", pageInfo.getPages());
